...
import { PaginaEgresosAdminComponent } from './admin/pages/pagina-ventas-admin/pagina-egresos-admin.component';
import { PaginaRealizarVentaAdminComponent } from './admin/pages/pagina-realizar-egresos-admin/pagina-realizar-egresos-admin.component';
