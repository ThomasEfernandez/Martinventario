...
@Component({
  ...
  imports: [RouterOutlet, ProveedoresComponent, ProductosComponent, CategoriasComponent,
    EtiquetasComponent, PaginaPrincipalComponent, AgregarUsuarioComponent, IniciarSesionComponent, PaginaPrincipalAdminComponent, PaginaProductosAdminComponent],
