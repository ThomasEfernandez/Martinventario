...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, IniciarSesionComponent, RealizarPedidoComponent, PaginaPedidoComponent, PaginaPrincipalComponent, ListarCategoriasComponent, ListarProductosComponent],
